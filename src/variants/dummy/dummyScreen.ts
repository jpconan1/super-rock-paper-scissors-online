...
export function mountDummyScreen(container: HTMLElement, clock: BoilClock, advance: () => void): () => void {
  ...
  const layout = createGameLayout({
    ...
    artwork: {
      ...
      scene: { src: '/variants/dummy/scenes/dummy-scene.png', alt: '', boiling: false },
    },
    variantContent: {
